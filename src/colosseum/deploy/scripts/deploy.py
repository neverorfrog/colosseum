...
group.add_argument(
    "--task",
    type=str,
    help="Task name (e.g., 't1_23dof_velocity')"
)
group.add_argument(
    "-l",
    "--list",
...
def discover_tasks():
    ...
    for task_dir in tasks_dir.iterdir():
        ...
        for robot_deploy_dir in deploy_dir.iterdir():
            ...
            module_path = f"colosseum.tasks.{task_dir.name}.deploy.{robot_deploy_dir.name}"
            ...
            try:
                ...
                for attr_name in dir(module):
                    if attr_name.endswith("_DEPLOY_CFG") and not attr_name.startswith("_"):
...
def main():
    ...
    if args.mujoco:
        ...
        from colosseum.deploy.core.controllers.booster_robot_controller import (
            BoosterRobotPortal,
        )
