...
class RemoteControlService:
    ...
    def _run_joystick(self):
        ...
        while self._running:
            try:
                ...
                if (
                    not self._running
                ):  # If the exception was caused by shutdown, no need to log
                    break
    ...
    def close(self):
        ...
        try:
            if (
                getattr(self, "_stdin_tty", False)
                and getattr(self, "_old_termios", None) is not None
            ):
                termios.tcsetattr(
        ...
        if (
            ...
            and getattr(self, "joystick_runner") is not None
        ):
            try:
        ...
        if (
            ...
            and getattr(self, "keyboard_runner") is not None
        ):
            try:
