...
from colosseum.mdp.amp_obs import amp_classic_obs_group
...
from colosseum.tasks.kick.mdp.observations import ball_angle_cos_sin
...
kick_actor_terms = {
  **proprio_terms,
  **ball_terms,
  # Goal kick direction (cos θ, sin θ) in the robot body frame.
  "ball_angle": MirrorableObservationTermCfg(
    func=ball_angle_cos_sin,
...
observations = {
  ...
  # AMP discriminator "state": [joint_pos_rel(23), joint_vel(23), base_lin_vel(3),
  # base_ang_vel(3)] = 52. Must match AmpMotionDataset element-for-element. Not a
  # skill group: never enters the ResidualActor / orchestrator / symmetry paths.
  "amp": amp_classic_obs_group(),
}
