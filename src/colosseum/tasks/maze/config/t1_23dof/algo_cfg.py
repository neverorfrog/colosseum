"""Algorithm configurations for Booster T1 maze task."""

from colosseum.config.types.algorithm import DaggerPpoConfig, PpoConfig
from colosseum.config.types.networks import PpoActorConfig, PpoCriticConfig


def t1_maze_ppo_cfg() -> PpoConfig:
  return PpoConfig(
    name="PPO",
...
# def t1_maze_ppo_cfg(teacher_checkpoint: str = "latest.pt") -> DaggerPpoConfig:
#   return DaggerPpoConfig(
#     name="DaggerPPO",
#     target="colosseum.algorithm.dagger_ppo:DaggerPPO",
#     learning_steps=500_000_000,
#     num_steps_per_env=24,
#     gamma=0.99,
#     lam=0.95,
