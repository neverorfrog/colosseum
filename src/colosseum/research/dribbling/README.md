...
<!-- TODO: embed demo video thumbnail once available -->
...
Full documentation lives in `docs/dribbling/`:

| Document | Description |
|----------|-------------|
| `pipeline.md` | End-to-end pipeline with Mermaid diagrams |
| `training_plan.md` | RMA phases vs. obstacle stages |
| `obstacles.md` | Curriculum, scene setup, policy representation |
| `evaluation.md` | Evaluation conditions, metrics, runner |
| `visual_encoder_plan.md` | Phase 2 depth encoder architecture |
