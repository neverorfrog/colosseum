...
#     data: dict,
#     backend: str = "numpy",
#     array_types: Iterable[str] = ("numpy", "torch", "warp"),
# ) -> dict:
...
#         raise ValueError(
#             f"Unknown backend '{backend}'. Supported backends are 'numpy', 'torch', and 'warp'."
#         )
...
#             raise ValueError(
#                 f"Unknown array type: '{t}'. Supported array types are 'numpy', 'torch', and 'warp'."
#             )
...
#                 raise ValueError(
#                     f"No registered conversion for data type: {data_type} to {backend}!"
#                 )
#             # convert the data to the desired backend.
