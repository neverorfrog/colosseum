...
# Multi-GPU from the same command (auto torchrun relaunch)
...
- `--cuda` accepts one id (`0`) for single-GPU or a comma-separated list (`0,1`) to auto-launch distributed training.
