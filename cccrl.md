...
`external/rsl_rl` (https://github.com/kniranjankumar/rsl_rl.git) with example configs from `external/legged_gym` (https://github.com/kniranjankumar/legged_gym.git).
