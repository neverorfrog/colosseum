...
def test_t1_env_cfgs_imports():
    ...
    from colosseum.tasks.velocity.config.t1_23dof import (
...
def test_t1_rough_env_cfg_structure():
    ...
    from colosseum.tasks.velocity.config.t1_23dof import booster_t1_rough_env_cfg
...
def test_t1_flat_env_cfg_structure():
    ...
    from colosseum.tasks.velocity.config.t1_23dof import booster_t1_flat_env_cfg
